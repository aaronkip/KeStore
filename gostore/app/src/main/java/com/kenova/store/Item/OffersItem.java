...
public class OffersItem extends RecyclerView.Adapter<OffersItem.ItemRowHolder> {
    ...
    public OffersItem(Context context, ArrayList<OffersModels> dataList, int rowLayout) {
