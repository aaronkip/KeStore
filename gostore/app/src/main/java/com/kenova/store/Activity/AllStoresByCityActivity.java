...
public class AllStoresByCityActivity extends AppCompatActivity {
    ...
    private void sort() {
        ...
        radioGroupSort.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int Check) {
                ...
                if (Check == R.id.sort_distance) {
                    save_sort=3;
                    if (NetworkUtils.isConnected(AllStoresByCityActivity.this)) {
                        JSONObject parameters = new JSONObject();
                        RequestQueue rq = Volley.newRequestQueue(AllStoresByCityActivity.this);
        ...
        mBottomSheetDialog = new BottomSheetDialog(AllStoresByCityActivity.this);
    ...
    private void getData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Constants.BYCITY+Id+ "&user_lat=" + Constants.LATITUDE + "&user_long=" + Constants.LONGITUDE, parameters, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String respo=response.toString();
                        Log.d("responce",respo);
