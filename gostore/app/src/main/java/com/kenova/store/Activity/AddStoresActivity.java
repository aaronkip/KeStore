...
public class AddStoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(AddStoresActivity.this);
        ...
        lladdress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddStoresActivity.this, PicklocationActivity.class);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(getname)){
                    Toast.makeText(AddStoresActivity.this, "Please Enter Store Name", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(getphone)){
                    Toast.makeText(AddStoresActivity.this, "Please Enter Phone", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(getopen)){
                    Toast.makeText(AddStoresActivity.this, "Please Enter Open Time", Toast.LENGTH_SHORT).show();
                }
                else if(getcity.isEmpty()){
                    Toast.makeText(AddStoresActivity.this, "Please Select City", Toast.LENGTH_SHORT).show();
                }
                else if(getcategory.isEmpty()){
                    Toast.makeText(AddStoresActivity.this, "Please Select Category", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(getclosed)){
                    Toast.makeText(AddStoresActivity.this, "Please Enter Closed Time", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(gettags)){
                    Toast.makeText(AddStoresActivity.this, "Please Enter Tags", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(getaddress)){
                    Toast.makeText(AddStoresActivity.this, "Please Enter Address", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(getdescription)){
                    Toast.makeText(AddStoresActivity.this, "Please Enter Description", Toast.LENGTH_SHORT).show();
                }
                else if(imageset ==null){
                    Toast.makeText(AddStoresActivity.this, "Select Image", Toast.LENGTH_SHORT).show();
                }
                else {
                    uploadData();
                }
            ...
            try {
                ...
                if (code.equals("200")) {
                    ...
                    for (int i = 0; i < msg.length(); i++) {
                        ...
                        ArrayAdapter<String> catSpinner = new ArrayAdapter<>(AddStoresActivity.this, R.layout.spinner, catNameList);
        ...
        try {
            ...
            if(code.equals("200")) {
                ...
                for (int i = 0; i < msg.length(); i++) {
                    ...
                    ArrayAdapter<String> citySpinner = new ArrayAdapter<>(AddStoresActivity.this, R.layout.spinner, cityNameList);
    ...
    public void uploadData() {
        Requesthttp request = Requesthttp.create(Constants.ADDSTORES);
                ...
                .setResponseListener(new JsonResponseListener() {
                    ...
                    public void onOkResponse(JSONObject jsonObject) throws JSONException {
                        ...
                        if (Constants.successmsg == 0) {
                            ...
                            Toast.makeText(AddStoresActivity.this, message, Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(AddStoresActivity.this, message, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(AddStoresActivity.this, MainActivity.class);
