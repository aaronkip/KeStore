...
public class AllEventsItem extends RecyclerView.Adapter<AllEventsItem.ItemRowHolder> {
    ...
    public AllEventsItem(Context context, ArrayList<EventsModels> dataList, int rowLayout) {
