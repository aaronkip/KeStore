...
public class EditOffersActivity extends AppCompatActivity {
    EditText name, tags, description, lat, lon, price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(EditOffersActivity.this);
        ...
        toolbartext.setText("Edit Offer");
        getData();
        ...
        lladdress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EditOffersActivity.this, PicklocationActivity.class);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(getname)){
                    Toast.makeText(EditOffersActivity.this, "Please Enter Offer Name", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(getopen)){
                    Toast.makeText(EditOffersActivity.this, "Please Enter Date Start", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(getclosed)){
                    Toast.makeText(EditOffersActivity.this, "Please Enter Date End", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(gettags)){
                    Toast.makeText(EditOffersActivity.this, "Please Enter Tags", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(getaddress)){
                    Toast.makeText(EditOffersActivity.this, "Please Enter Address", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(getdescription)){
                    Toast.makeText(EditOffersActivity.this, "Please Enter Description", Toast.LENGTH_SHORT).show();
                }
                else if(imageset ==null){
                    Toast.makeText(EditOffersActivity.this, "Select Image", Toast.LENGTH_SHORT).show();
                }
                else {
                    uploadData();
                }
    ...
    public void uploadData() {
        Requesthttp request = Requesthttp.create(Constants.EDITOFFERS);
            request.setMethod("POST")
                    .setTimeout(0)
                    .setLogger(new Logger(Logger.ERROR))
                    .addParameter("offerid", offerId)
                    .addParameter("offersname", name.getText().toString())
                    .addParameter("price", price.getText().toString())
                    .addParameter("storeid", Id)
                    .addParameter("odescription", description.getText().toString())
                    .addParameter("otags", tags.getText().toString())
                    .addParameter("oaddress", address.getText().toString())
                    .addParameter("olatitude", lat.getText().toString())
                    .addParameter("olongitude", lon.getText().toString())
                ...
                .setResponseListener(new JsonResponseListener() {
                    ...
                    public void onOkResponse(JSONObject jsonObject) throws JSONException {
                        ...
                        if (Constants.successmsg == 0) {
                            ...
                            Toast.makeText(EditOffersActivity.this, message, Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(EditOffersActivity.this, message, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(EditOffersActivity.this, MainActivity.class);
    ...
    private void getData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Constants.OFFERDATA +offerId, parameters, new Response.Listener<JSONObject>() {
                    @Override
